...
capture_code = "/home/pi/hasp_temp/flight_UPPER/capt/capture"
...
class Cameras():
	...
	def science(self):
		...
		sci_name = "/home/pi/hasp_temp/flight/images/SCI_" + str(t[3]) + "-" + str(t[4]) + "-" + str(t[5]) + str(random.randint(0, 2**32)) + ".png"
		with self.lock:
